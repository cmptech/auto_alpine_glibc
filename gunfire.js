...
*/
const argv2o = a => (a || require('process').argv || []).reduce((r, e) => ((m = e.match(/^(\/|--?)([\w-]*)="?(.*)"?$/)) && (r[m[2]] = m[3]), r), {}), p4web = require('p4web'), wrapeval = require('wrapeval')
	,argo = argv2o()
...
var {web1_p,s2o} = p4web({cookie_pack:'play_gunfire'});
...
gh({url:gh_url,gh_token}).then(o=>wrapeval(o,this))
